...
public final class GoogleAuthUtil extends zzd {
    ...
    private static TokenData zzb(Context context, Account account, String str, Bundle bundle) throws UserRecoverableNotifiedException {
        if (bundle == null) {
            bundle = new Bundle();
        }
        try {
            TokenData tokenDataZzc = zzc(context, account, str, bundle);
