...
public class GoogleSignInAccount implements SafeParcelable {
    ...
    private static Comparator zzWV = new Comparator() { // from class: com.google.android.gms.auth.api.signin.GoogleSignInAccount.1
    ...
    public static GoogleSignInAccount zza(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable String str4, @Nullable Uri uri, @Nullable Long l, @NonNull String str5, @NonNull Set set) {
        if (l == null) {
    ...
    @Nullable
    public static GoogleSignInAccount zzbH(@Nullable String str) throws JSONException, NumberFormatException {
        ...
        return zza(jSONObject.optString("id"), jSONObject.optString("tokenId", null), jSONObject.optString("email", null), jSONObject.optString("displayName", null), uri, Long.valueOf(j), jSONObject.getString("obfuscatedIdentifier"), hashSet).zzbI(jSONObject.optString("serverAuthCode", null));
    }
    ...
    private JSONObject zzmJ() throws JSONException {
        ...
        try {
            ...
            Iterator it = this.zzVs.iterator();
            while (it.hasNext()) {
    ...
    public String zzmM() throws JSONException {
        JSONObject jSONObjectZzmJ = zzmJ();
        jSONObjectZzmJ.remove("serverAuthCode");
        return jSONObjectZzmJ.toString();
    }
}
