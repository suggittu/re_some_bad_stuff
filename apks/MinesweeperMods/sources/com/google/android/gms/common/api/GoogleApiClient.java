...
public abstract class GoogleApiClient {
    ...
    public final class Builder {
        ...
        private static Api.zzb zza(Api.zza zzaVar, Object obj, Context context, Looper looper, zzf zzfVar, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
            return zzaVar.zza(context, looper, zzfVar, obj, connectionCallbacks, onConnectionFailedListener);
        }

        private static zzad zza(Api.zze zzeVar, Object obj, Context context, Looper looper, zzf zzfVar, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
            return new zzad(context, looper, zzeVar.zzoU(), connectionCallbacks, onConnectionFailedListener, zzfVar, zzeVar.zzq(obj));
        }

        private void zza(Api api, Api.ApiOptions apiOptions, int i, Scope... scopeArr) {
            boolean z = true;
            if (i != 1) {
                if (i != 2) {
            ...
            HashSet hashSet = new HashSet(api.zzoP().zzo(apiOptions));
        ...
        private GoogleApiClient zzoZ() {
            ...
            for (Api api4 : this.zzagn.keySet()) {
                ...
                int i = mapZzqu.get(api4) != null ? ((zzf.zza) mapZzqu.get(api4)).zzalf ? 1 : 2 : 0;
                ...
                if (api4.zzoS()) {
                    Api.zze zzeVarZzoQ = api4.zzoQ();
                    Api api5 = zzeVarZzoQ.getPriority() == 1 ? api4 : api3;
                    zzbVarZza = zza(zzeVarZzoQ, obj, this.mContext, this.zzagr, zzfVarZzoY, zzcVar, zzcVar);
                    api = api5;
                } else {
                    Api.zza zzaVarZzoP = api4.zzoP();
                    Api api6 = zzaVarZzoP.getPriority() == 1 ? api4 : api3;
                    zzbVarZza = zza(zzaVarZzoP, obj, this.mContext, this.zzagr, zzfVarZzoY, zzcVar, zzcVar);
                    api = api6;
                }
        ...
        public final Builder addApi(@NonNull Api api) {
            zzx.zzb(api, "Api must not be null");
            this.zzagn.put(api, null);
            List listZzo = api.zzoP().zzo(null);
            this.zzagi.addAll(listZzo);
            this.zzagh.addAll(listZzo);
            return this;
        }

        public final Builder addApi(@NonNull Api api, @NonNull Api.ApiOptions.HasOptions hasOptions) {
            zzx.zzb(api, "Api must not be null");
            zzx.zzb(hasOptions, "Null options are not permitted for this Api");
            this.zzagn.put(api, hasOptions);
            List listZzo = api.zzoP().zzo(hasOptions);
            this.zzagi.addAll(listZzo);
            this.zzagh.addAll(listZzo);
            return this;
        }

        public final Builder addApiIfAvailable(@NonNull Api api, @NonNull Api.ApiOptions.HasOptions hasOptions, Scope... scopeArr) {
            zzx.zzb(api, "Api must not be null");
            zzx.zzb(hasOptions, "Null options are not permitted for this Api");
            this.zzagn.put(api, hasOptions);
            zza(api, hasOptions, 1, scopeArr);
            return this;
        }

        public final Builder addApiIfAvailable(@NonNull Api api, Scope... scopeArr) {
            zzx.zzb(api, "Api must not be null");
            this.zzagn.put(api, null);
    ...
    @NonNull
    public Api.zzb zza(@NonNull Api.zzc zzcVar) {
        throw new UnsupportedOperationException();
    }
    ...
    public zzq zzr(@NonNull Object obj) {
        throw new UnsupportedOperationException();
    }
}
