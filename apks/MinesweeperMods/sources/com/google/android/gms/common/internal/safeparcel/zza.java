...
public class zza {
    ...
    public class C0039zza extends RuntimeException {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        int iZza = zza(parcel, i);
        if (iZza != i2) {
            throw new C0039zza("Expected size " + i2 + " got " + iZza + " (0x" + Integer.toHexString(iZza) + ")", parcel);
        }
    }
    ...
    public static int zzau(Parcel parcel) {
        ...
        int iDataPosition = parcel.dataPosition();
        if (zzca(iZzat) != 20293) {
            throw new C0039zza("Expected object header. Got 0x" + Integer.toHexString(iZzat), parcel);
        }
        int i = iDataPosition + iZza;
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new C0039zza("Size read is invalid start=" + iDataPosition + " end=" + i, parcel);
        }
        return i;
    }
