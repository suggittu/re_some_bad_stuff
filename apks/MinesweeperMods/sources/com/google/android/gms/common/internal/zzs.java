...
public interface zzs extends IInterface {
    ...
    public abstract class zza extends Binder implements zzs {
        ...
        public static zzs zzaS(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzs)) ? new C0043zza(iBinder) : (zzs) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 46:
                    parcel.enforceInterface("com.google.android.gms.common.internal.IGmsServiceBroker");
                    zza(zzr.zza.zzaR(parcel.readStrongBinder()), parcel.readInt() != 0 ? (GetServiceRequest) GetServiceRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 47:
                    parcel.enforceInterface("com.google.android.gms.common.internal.IGmsServiceBroker");
                    zza(zzr.zza.zzaR(parcel.readStrongBinder()), parcel.readInt() != 0 ? (ValidateAccountRequest) ValidateAccountRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
