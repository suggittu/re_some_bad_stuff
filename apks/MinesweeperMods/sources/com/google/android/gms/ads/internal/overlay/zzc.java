...
public class zzc extends zzi implements AudioManager.OnAudioFocusChangeListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, TextureView.SurfaceTextureListener {
    ...
    private void zzfa() throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
    ...
    private void zzfb() throws IllegalStateException {
    ...
    public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        final String str = (String) zzDN.get(Integer.valueOf(i));
        final String str2 = (String) zzDN.get(Integer.valueOf(i2));
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
        zzin.v("AdMediaPlayerView MediaPlayer info: " + ((String) zzDN.get(Integer.valueOf(i))) + ":" + ((String) zzDN.get(Integer.valueOf(i2))));
        return true;
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) throws IllegalStateException {
    ...
    @Override // android.view.TextureView.SurfaceTextureListener
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) throws IllegalStateException {
