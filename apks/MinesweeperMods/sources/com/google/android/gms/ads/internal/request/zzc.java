...
public final class zzc {
    ...
    public static zzit zza(final Context context, VersionInfoParcel versionInfoParcel, zzji zzjiVar, zza zzaVar) {
        return zza(context, versionInfoParcel, zzjiVar, zzaVar, new zzb() { // from class: com.google.android.gms.ads.internal.request.zzc.1
            ...
            public final boolean zza(VersionInfoParcel versionInfoParcel2) {
                return versionInfoParcel2.zzNb || (com.google.android.gms.common.zze.zzap(context) && !((Boolean) zzbt.zzwb.get()).booleanValue());
            }
        });
    }

    static zzit zza(Context context, VersionInfoParcel versionInfoParcel, zzji zzjiVar, zza zzaVar, zzb zzbVar) {
