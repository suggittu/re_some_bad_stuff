...
public class zzf extends com.google.android.gms.dynamic.zzg {
    public zzf() {
    ...
    private zzb zzb(Context context, zzew zzewVar) {
        try {
            return zzb.zza.zzaa(((zzc) zzaB(context)).zza(com.google.android.gms.dynamic.zze.zzC(context), zzewVar, 8487000));
