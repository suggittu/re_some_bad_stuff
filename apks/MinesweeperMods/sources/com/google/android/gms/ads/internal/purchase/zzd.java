...
public class zzd extends zzgc.zza {
    ...
    @Override // com.google.android.gms.internal.zzgc
    public void recordPlayBillingResolution(int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (i == 0) {
            zzfX();
        }
        ...
        map.put("status", String.valueOf(zzB(i)));
        LinkedList linkedList = new LinkedList();
        Iterator it = this.zzFJ.iterator();
        while (it.hasNext()) {
            linkedList.add(zza((String) it.next(), map));
        }
        zzr.zzbC().zza(this.mContext, this.zzsy, linkedList);
    }

    @Override // com.google.android.gms.internal.zzgc
    public void recordResolution(int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (i == 1) {
            zzfX();
        }
        HashMap map = new HashMap();
    ...
    protected String zza(String str, HashMap map) {
        String str2;
    ...
    void zzfX() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
