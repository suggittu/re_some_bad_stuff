...
class zzh implements zzaj, Runnable {
    ...
    private Context zzq(Context context) {
        ...
        return (((Boolean) zzbt.zzvM.get()).booleanValue() && (applicationContext = context.getApplicationContext()) != null) ? applicationContext : context;
    }
    ...
    public void zza(int i, int i2, int i3) {
        zzaj zzajVar = (zzaj) this.zzpI.get();
        if (zzajVar == null) {
    ...
    public String zzb(Context context) {
        zzaj zzajVar;
        if (!zzbj() || (zzajVar = (zzaj) this.zzpI.get()) == null) {
            return "";
        }
        zzbk();
    ...
    protected boolean zzbj() throws InterruptedException {
        try {
            this.zzpJ.await();
            return true;
