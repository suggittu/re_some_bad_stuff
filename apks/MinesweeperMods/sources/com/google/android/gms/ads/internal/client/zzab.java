...
public class zzab {
    ...
    private void zzdf() {
        try {
            com.google.android.gms.dynamic.zzd zzdVarZzaM = this.zzuL.zzaM();
            if (zzdVarZzaM == null) {
                return;
            }
            this.zzuN.addView((View) com.google.android.gms.dynamic.zze.zzp(zzdVarZzaM));
    ...
    public AdSize getAdSize() {
        ...
        try {
            if (this.zzuL != null && (adSizeParcelZzaN = this.zzuL.zzaN()) != null) {
                return adSizeParcelZzaN.zzcQ();
            }
        } catch (RemoteException e) {
