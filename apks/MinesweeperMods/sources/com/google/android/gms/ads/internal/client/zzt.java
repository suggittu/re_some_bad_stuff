...
public interface zzt extends IInterface {
    ...
    public abstract class zza extends Binder implements zzt {
        ...
        class C0005zza implements zzt {
            ...
            public IBinder zza(com.google.android.gms.dynamic.zzd zzdVar, String str, zzex zzexVar, int i) {
        ...
        public static zzt zzj(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzt)) ? new C0005zza(iBinder) : (zzt) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    IBinder iBinderZza = zza(zzd.zza.zzbs(parcel.readStrongBinder()), parcel.readString(), zzex.zza.zzE(parcel.readStrongBinder()), parcel.readInt());
    ...
    IBinder zza(com.google.android.gms.dynamic.zzd zzdVar, String str, zzex zzexVar, int i);
}
