...
public class zzm {
    private static com.google.android.gms.ads.internal.formats.zzd zza(zzfb zzfbVar) {
    ...
    private static com.google.android.gms.ads.internal.formats.zze zza(zzfc zzfcVar) {
    ...
    public static void zza(zzif zzifVar, zzf.zza zzaVar) {
        if (zzg(zzifVar)) {
            ...
            try {
                ...
                if (!list.contains("1") || zzfcVarZzeG == null) {
    ...
    private static void zza(final zzjp zzjpVar, final com.google.android.gms.ads.internal.formats.zzd zzdVar, final String str) {
        zzjpVar.zzhU().zza(new zzjq.zza() { // from class: com.google.android.gms.ads.internal.zzm.1
            ...
            public final void zza(zzjp zzjpVar2, boolean z) throws JSONException {
                try {
                    JSONObject jSONObject = new JSONObject();
                    ...
                    jSONObject.put("icon", zzm.zza(zzdVar.zzdK()));
                    ...
                    jSONObject.put("extras", zzm.zza(zzdVar.getExtras(), str));
        ...
        zzjpVar.zzhU().zza(new zzjq.zza() { // from class: com.google.android.gms.ads.internal.zzm.2
            ...
            public final void zza(zzjp zzjpVar2, boolean z) throws JSONException {
                try {
                    ...
                    jSONObject.put("images", jSONArray);
                    jSONObject.put("extras", zzm.zza(zzeVar.getExtras(), str));
                    JSONObject jSONObject2 = new JSONObject();
                    jSONObject2.put("assets", jSONObject);
    ...
    private static boolean zzb(zzjp zzjpVar, zzes zzesVar, CountDownLatch countDownLatch) {
        View view = zzjpVar.getView();
        if (view == null) {
            zzin.zzaK("AdWebView is null");
            return false;
