...
class zzdb extends zzak {
    ...
    @Override // com.google.android.gms.tagmanager.zzak
    public zzag.zza zzP(Map map) throws NumberFormatException {
        long j;
        long j2;
        String strZzg = zzdf.zzg((zzag.zza) map.get(NAME));
        String strZzg2 = zzdf.zzg((zzag.zza) map.get(zzblr));
        String strZzg3 = zzdf.zzg((zzag.zza) map.get(zzblp));
        String strZzg4 = zzdf.zzg((zzag.zza) map.get(zzblq));
        try {
