...
public class zzgu extends zzgq {
    ...
    private void zzgk() throws InterruptedException, zzgq.zza {
    ...
    @Override // com.google.android.gms.internal.zzgq
    protected void zzh(long j) throws InterruptedException, zzgq.zza {
        synchronized (this.zzGg) {
            this.zzGy = zzi(j);
        }
    ...
    zzem zzi(long j) {
        return this.zzCf.zzBX != -1 ? new zzeu(this.mContext, this.zzGd.zzLd, this.zzpn, this.zzCf, this.zzGe.zzuk, this.zzGe.zzum, j, ((Long) zzbt.zzwY.get()).longValue(), 2) : new zzev(this.mContext, this.zzGd.zzLd, this.zzpn, this.zzCf, this.zzGe.zzuk, this.zzGe.zzum, j, ((Long) zzbt.zzwY.get()).longValue(), this.zzpe);
    }
}
