...
public interface zzow extends IInterface {
    ...
    public abstract class zza extends Binder implements zzow {

        /* renamed from: com.google.android.gms.internal.zzow$zza$zza, reason: collision with other inner class name */
        class C0147zza implements zzow {
        ...
        public static zzow zzbR(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzow)) ? new C0147zza(iBinder) : (zzow) iInterfaceQueryLocalInterface;
        }
