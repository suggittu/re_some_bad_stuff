...
public final class zziq {
    ...
    public static zzjg zza(int i, final Runnable runnable) {
        return i == 1 ? zza(zzLV, new Callable() { // from class: com.google.android.gms.internal.zziq.1
        ...
        }) : zza(zzLU, new Callable() { // from class: com.google.android.gms.internal.zziq.2
            @Override // java.util.concurrent.Callable
            /* renamed from: zzdt, reason: merged with bridge method [inline-methods] */
            public final Void call() {
                runnable.run();
    ...
    public static zzjg zza(ExecutorService executorService, final Callable callable) {
