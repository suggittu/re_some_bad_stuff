...
public interface zzos extends IInterface {
    ...
    public abstract class zza extends Binder implements zzos {
        ...
        class C0143zza implements zzos {
        ...
        public static zzos zzbN(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzos)) ? new C0143zza(iBinder) : (zzos) iInterfaceQueryLocalInterface;
        }
    ...
    void zza(ReadRawResult readRawResult);
}
