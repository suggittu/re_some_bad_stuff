...
public class zzlh extends zzlg {
    ...
    public zzlh(Activity activity, List list) {
        super(activity, zzYf, list);
    }

    public static void zzag(Context context) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
    ...
    private void zznv() throws IllegalAccessException, InstantiationException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        if (this.zzYj != null) {
    ...
    private Object zznw() throws ClassNotFoundException {
        ...
        return Proxy.newProxyInstance(cls2.getClassLoader(), new Class[]{cls2}, new InvocationHandler() { // from class: com.google.android.gms.internal.zzlh.1
            ...
            public Object invoke(Object obj, Method method, Object[] objArr) throws ClassNotFoundException {
                ...
                if (!((Boolean) cls.getDeclaredMethod("isOpened", new Class[0]).invoke(objArr[0], new Object[0])).booleanValue()) {
                    return null;
                }
    ...
    @Override // com.google.android.gms.internal.zzlf
    public boolean zza(int i, int i2, Intent intent, zzlf.zza zzaVar) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        zzb(zzaVar);
