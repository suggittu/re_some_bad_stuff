...
public class zznn extends com.google.android.gms.drive.metadata.internal.zzk {
    ...
    private static void zzc(DataHolder dataHolder) {
        synchronized (dataHolder) {
            ...
            try {
                LongSparseArray longSparseArrayZzf = zzf(dataHolder2);
                SparseArray<? extends Parcelable> sparseArray = new SparseArray<>();
                for (int i = 0; i < dataHolder.getCount(); i++) {
                    AppVisibleCustomProperties.zza zzaVar = (AppVisibleCustomProperties.zza) longSparseArrayZzf.get(dataHolder.zzb("sqlId", i, dataHolder.zzbH(i)));
                    if (zzaVar != null) {
    ...
    private static LongSparseArray zzf(DataHolder dataHolder) {
        ...
        while (true) {
            ...
            AppVisibleCustomProperties.zza zzaVar = (AppVisibleCustomProperties.zza) longSparseArray.get(jZzb);
            if (zzaVar == null) {
