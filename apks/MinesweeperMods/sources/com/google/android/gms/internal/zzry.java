...
public interface zzry extends IInterface {

    public abstract class zza extends Binder implements zzry {

        /* renamed from: com.google.android.gms.internal.zzry$zza$zza, reason: collision with other inner class name */
        class C0168zza implements zzry {
        ...
        public static zzry zzek(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzry)) ? new C0168zza(iBinder) : (zzry) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 2:
                    ...
                    zza(parcel.readInt(), parcel.readInt(), parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
    ...
    void zza(int i, int i2, Bundle bundle);
}
