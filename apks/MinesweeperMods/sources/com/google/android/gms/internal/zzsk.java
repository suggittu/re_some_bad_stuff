...
public final class zzsk extends zzso {
    public String[] zzbtT;
    public int[] zzbtU;
    public byte[][] zzbtV;
    ...
    public static zzsk zzB(byte[] bArr) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzss.equals(this.zzbtT, zzskVar.zzbtT) && zzss.equals(this.zzbtU, zzskVar.zzbtU) && zzss.zza(this.zzbtV, zzskVar.zzbtV)) {
            return (this.zzbuj == null || this.zzbuj.isEmpty()) ? zzskVar.zzbuj == null || zzskVar.zzbuj.isEmpty() : this.zzbuj.equals(zzskVar.zzbuj);
        }
        return false;
    }
    ...
    public final zzsk mergeFrom(zzsm zzsmVar) throws zzst {
        while (true) {
