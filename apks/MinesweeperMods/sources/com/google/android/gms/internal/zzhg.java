...
public final class zzhg {
    ...
    static String zzd(Map map, String str) {
    ...
    static long zze(Map map, String str) {
        List list = (List) map.get(str);
        if (list != null && !list.isEmpty()) {
    ...
    static List zzf(Map map, String str) {
        String str2;
        List list = (List) map.get(str);
    ...
    private boolean zzg(Map map, String str) {
        List list = (List) map.get(str);
    ...
    private void zzl(Map map) {
        List listZzf = zzf(map, "X-Afma-Click-Tracking-Urls");
        if (listZzf != null) {
            this.zzJp = listZzf;
        }
    }
    ...
    private void zzn(Map map) {
        List listZzf = zzf(map, "X-Afma-Tracking-Urls");
        if (listZzf != null) {
            this.zzJs = listZzf;
        }
    }
    ...
    private void zzt(Map map) {
        List listZzf = zzf(map, "X-Afma-Manual-Tracking-Urls");
        if (listZzf != null) {
            this.zzGK = listZzf;
        }
    }
    ...
    public final void zzb(String str, Map map, String str2) {
        this.zzJo = str;
        this.zzxY = str2;
        zzj(map);
    }
