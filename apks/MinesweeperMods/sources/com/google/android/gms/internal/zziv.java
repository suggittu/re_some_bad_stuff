...
public class zziv {
    ...
    public class zzb {
        ...
        public zzb zza(String str, double d, double d2) {
            ...
            while (true) {
                ...
                double dDoubleValue = ((Double) this.zzMx.get(i)).doubleValue();
                double dDoubleValue2 = ((Double) this.zzMw.get(i)).doubleValue();
    ...
    public List getBuckets() {
        ...
        while (true) {
            ...
            arrayList.add(new zza(this.zzMn[i2], this.zzMp[i2], this.zzMo[i2], this.zzMq[i2] / this.zzMr, this.zzMq[i2]));
            i = i2 + 1;
        }
    }
