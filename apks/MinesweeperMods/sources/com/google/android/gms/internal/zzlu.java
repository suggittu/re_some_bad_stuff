...
public interface zzlu extends IInterface {
    ...
    public abstract class zza extends Binder implements zzlu {
        ...
        public static zzlu zzaJ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzlu)) ? new C0125zza(iBinder) : (zzlu) iInterfaceQueryLocalInterface;
        }
