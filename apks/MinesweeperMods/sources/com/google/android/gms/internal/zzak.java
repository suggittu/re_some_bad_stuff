...
public abstract class zzak implements zzaj {
    ...
    protected String zza(NanoAfmaSignals.AFMASignals aFMASignals, String str) {
        return zza(zzsu.toByteArray(aFMASignals), str);
    }

    String zza(byte[] bArr, String str) throws NoSuchAlgorithmException {
        byte[] bArrArray;
        if (bArr.length > 239) {
    ...
    public void zza(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            ...
            case 1:
                ...
                break;
            case 2:
                this.zznA += motionEvent.getHistorySize() + 1;
                break;
            case 3:
                this.zznC++;
                break;
