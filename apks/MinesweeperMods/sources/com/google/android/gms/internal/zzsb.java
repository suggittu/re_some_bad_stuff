...
public interface zzsb extends IInterface {

    public abstract class zza extends Binder implements zzsb {

        /* renamed from: com.google.android.gms.internal.zzsb$zza$zza, reason: collision with other inner class name */
        class C0172zza implements zzsb {
        ...
        public static zzsb zzen(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzsb)) ? new C0172zza(iBinder) : (zzsb) iInterfaceQueryLocalInterface;
        }
