...
public final class zzsn {
    ...
    public final void zzA(int i, int i2) throws zza {
        zzE(i, 0);
        zzmv(i2);
    }

    public final void zzB(int i, int i2) throws zza {
        zzE(i, 0);
        zzmw(i2);
    }

    public final void zzE(int i, int i2) throws zza {
        zzmB(zzsx.zzF(i, i2));
    }

    public final void zzF(byte[] bArr) throws zza {
        zzmB(bArr.length);
        zzH(bArr);
    }

    public final void zzH(byte[] bArr) throws zza {
    ...
    public final void zza(int i, double d) throws zza {
        zzE(i, 1);
        zzk(d);
    }

    public final void zza(int i, long j) throws zza {
        zzE(i, 0);
        zzau(j);
    }

    public final void zza(int i, zzsu zzsuVar) throws zza {
        zzE(i, 2);
        zzc(zzsuVar);
    }

    public final void zza(int i, byte[] bArr) throws zza {
        zzE(i, 2);
        zzF(bArr);
    }

    public final void zzao(long j) throws zza {
        zzau(j);
    }

    public final void zzap(long j) throws zza {
        zzau(j);
    }

    public final void zzaq(long j) throws zza {
        zzau(zzax(j));
    }

    public final void zzau(long j) throws zza {
        while (((-128) & j) != 0) {
            zzb((byte) ((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | 128));
            j >>>= 7;
        }
        zzb((byte) j);
    }

    public final void zzaw(long j) throws zza {
    ...
    public final void zzaz(boolean z) throws zza {
        zzb((byte) (z ? 1 : 0));
    }

    public final void zzb(byte b) throws zza {
    ...
    public final void zzb(int i, float f) throws zza {
        zzE(i, 5);
        zzj(f);
    }

    public final void zzb(int i, long j) throws zza {
        zzE(i, 0);
        zzau(j);
    }
    ...
    public final void zzc(int i, long j) throws zza {
        zzE(i, 0);
        zzaq(j);
    }

    public final void zzc(zzsu zzsuVar) throws zza {
        zzmB(zzsuVar.getCachedSize());
        zzsuVar.writeTo(this);
    }

    public final void zzc(byte[] bArr, int i, int i2) throws zza {
    ...
    public final void zze(int i, boolean z) throws zza {
        zzE(i, 0);
        zzaz(z);
    }

    public final void zzgN(String str) throws zza {
        try {
    ...
    public final void zzj(float f) throws zza {
        zzmD(Float.floatToIntBits(f));
    }

    public final void zzk(double d) throws zza {
        zzaw(Double.doubleToLongBits(d));
    }

    public final void zzmB(int i) throws zza {
        while ((i & (-128)) != 0) {
            zzb((byte) ((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | 128));
            i >>>= 7;
        }
        zzb((byte) i);
    }

    public final void zzmD(int i) throws zza {
    ...
    public final void zzmv(int i) throws zza {
        if (i >= 0) {
            zzmB(i);
        } else {
            zzau(i);
    ...
    public final void zzmw(int i) throws zza {
        zzmB(zzmE(i));
    }

    public final void zzmz(int i) throws zza {
        zzb((byte) i);
    }

    public final void zzn(int i, String str) throws zza {
        zzE(i, 2);
        zzgN(str);
    }
}
