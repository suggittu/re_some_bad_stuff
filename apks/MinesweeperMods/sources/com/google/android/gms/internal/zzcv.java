...
public class zzcv extends com.google.android.gms.dynamic.zzg {
    public zzcv() {
    ...
    private zzcj zzb(Context context, FrameLayout frameLayout, FrameLayout frameLayout2) {
        try {
            return zzcj.zza.zzu(((zzck) zzaB(context)).zza(com.google.android.gms.dynamic.zze.zzC(context), com.google.android.gms.dynamic.zze.zzC(frameLayout), com.google.android.gms.dynamic.zze.zzC(frameLayout2), 8487000));
