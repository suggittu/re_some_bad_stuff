...
public abstract class zzau implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    private WeakReference zzrX = new WeakReference(null);
    private boolean zzsh = true;
    private boolean zzsj = false;
    private zziz zzrQ = new zziz(200);

    public class zza implements zzbb {
        ...
        public View zzco() {
            com.google.android.gms.ads.internal.formats.zzh zzhVar = (com.google.android.gms.ads.internal.formats.zzh) this.zzsq.get();
            if (zzhVar != null) {
                return zzhVar.zzdS();
            }
            return null;
        ...
        @Override // com.google.android.gms.internal.zzbb
        public zzbb zzcq() {
            return new zzb((com.google.android.gms.ads.internal.formats.zzh) this.zzsq.get());
        }
    }

    public class zzb implements zzbb {
    ...
    public class zzc implements zzbb {
    ...
    public class zzd implements zzbb {
    ...
    protected void zzci() {
        ...
        if (viewZzco == null || (viewTreeObserver2 = viewZzco.getViewTreeObserver()) == (viewTreeObserver = (ViewTreeObserver) this.zzrX.get())) {
            return;
        }
        zzcj();
