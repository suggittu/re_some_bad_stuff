...
public interface zzon extends IInterface {
    ...
    public abstract class zza extends Binder implements zzon {
        ...
        public static zzon zzbI(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzon)) ? new C0138zza(iBinder) : (zzon) iInterfaceQueryLocalInterface;
        }
    ...
    void zza(DeleteAllUserDataRequest deleteAllUserDataRequest);
}
