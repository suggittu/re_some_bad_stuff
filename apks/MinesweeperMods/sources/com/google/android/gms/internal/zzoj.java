...
public interface zzoj extends IInterface {
    ...
    public abstract class zza extends Binder implements zzoj {
        ...
        public static zzoj zzbE(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzoj)) ? new C0134zza(iBinder) : (zzoj) iInterfaceQueryLocalInterface;
        }
