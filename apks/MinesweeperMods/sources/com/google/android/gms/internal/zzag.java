        ...
        public final void writeTo(zzsn zzsnVar) throws zzsn.zza {
            ...
            if (this.zzjA != null && this.zzjA.length > 0) {
                for (int i3 = 0; i3 < this.zzjA.length; i3++) {
                    ...
                    if (zzaVar3 != null) {
                        zzsnVar.zza(5, zzaVar3);
                    }
                }
            }
            if (!this.zzjB.equals("")) {
                zzsnVar.zzn(6, this.zzjB);
            }
            if (!this.zzjC.equals("")) {
                zzsnVar.zzn(7, this.zzjC);
            }
            if (this.zzjD != 0) {
                zzsnVar.zzb(8, this.zzjD);
            }
            if (this.zzjH) {
                zzsnVar.zze(9, this.zzjH);
            }
            if (this.zzjG != null && this.zzjG.length > 0) {
                for (int i4 = 0; i4 < this.zzjG.length; i4++) {
                    zzsnVar.zzA(10, this.zzjG[i4]);
                }
            }
            if (this.zzjF != null && this.zzjF.length > 0) {
                for (int i5 = 0; i5 < this.zzjF.length; i5++) {
                    ...
                    if (zzaVar4 != null) {
                        zzsnVar.zza(11, zzaVar4);
                    }
                }
            }
            if (this.zzjE) {
                zzsnVar.zze(12, this.zzjE);
            }
