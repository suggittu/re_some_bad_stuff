...
public interface zzaf {
    ...
    public final class zze extends zzso {
        ...
        public final boolean equals(Object obj) {
            ...
            if (this.key == zzeVar.key && this.value == zzeVar.value) {
                return (this.zzbuj == null || this.zzbuj.isEmpty()) ? zzeVar.zzbuj == null || zzeVar.zzbuj.isEmpty() : this.zzbuj.equals(zzeVar.zzbuj);
            }
            return false;
        }
    ...
    public final class zzf extends zzso {
        ...
        public static zzf zzc(byte[] bArr) {
        ...
        public final boolean equals(Object obj) {
            ...
            if (zzss.equals(this.zziG, zzfVar.zziG) && zzss.equals(this.zziH, zzfVar.zziH) && zzss.equals(this.zziI, zzfVar.zziI) && zzss.equals(this.zziJ, zzfVar.zziJ) && zzss.equals(this.zziK, zzfVar.zziK) && zzss.equals(this.zziL, zzfVar.zziL) && zzss.equals(this.zziM, zzfVar.zziM) && zzss.equals(this.zziN, zzfVar.zziN)) {
                ...
                if (Float.floatToIntBits(this.zziS) == Float.floatToIntBits(zzfVar.zziS) && this.zziT == zzfVar.zziT && zzss.equals(this.zziU, zzfVar.zziU) && this.zziV == zzfVar.zziV) {
                    return (this.zzbuj == null || this.zzbuj.isEmpty()) ? zzfVar.zzbuj == null || zzfVar.zzbuj.isEmpty() : this.zzbuj.equals(zzfVar.zzbuj);
                }
                return false;
            }
            return false;
    ...
    public final class zzg extends zzso {
        ...
        public final boolean equals(Object obj) {
            ...
            if (zzss.equals(this.zziX, zzgVar.zziX) && zzss.equals(this.zziY, zzgVar.zziY) && zzss.equals(this.zziZ, zzgVar.zziZ) && zzss.equals(this.zzja, zzgVar.zzja) && zzss.equals(this.zzjb, zzgVar.zzjb) && zzss.equals(this.zzjc, zzgVar.zzjc) && zzss.equals(this.zzjd, zzgVar.zzjd) && zzss.equals(this.zzje, zzgVar.zzje) && zzss.equals(this.zzjf, zzgVar.zzjf) && zzss.equals(this.zzjg, zzgVar.zzjg)) {
                return (this.zzbuj == null || this.zzbuj.isEmpty()) ? zzgVar.zzbuj == null || zzgVar.zzbuj.isEmpty() : this.zzbuj.equals(zzgVar.zzbuj);
            }
            return false;
        }
    ...
    public final class zzh extends zzso {
        public static final zzsp zzjh = zzsp.zza(11, zzh.class, 810);
        ...
        public final boolean equals(Object obj) {
            ...
            if (zzss.equals(this.zzjj, zzhVar.zzjj) && zzss.equals(this.zzjk, zzhVar.zzjk) && zzss.equals(this.zzjl, zzhVar.zzjl) && this.zzjm == zzhVar.zzjm && zzss.equals(this.zzjn, zzhVar.zzjn) && this.zzjo == zzhVar.zzjo && this.zzjp == zzhVar.zzjp) {
                return (this.zzbuj == null || this.zzbuj.isEmpty()) ? zzhVar.zzbuj == null || zzhVar.zzbuj.isEmpty() : this.zzbuj.equals(zzhVar.zzbuj);
            }
            return false;
        }
        ...
        public final zzh mergeFrom(zzsm zzsmVar) throws zzst {
            while (true) {
                int iZzIX = zzsmVar.zzIX();
                switch (iZzIX) {
                    case 0:
    ...
    public final class zzi extends zzso {
        ...
        public final boolean equals(Object obj) {
            ...
            return (this.zzbuj == null || this.zzbuj.isEmpty()) ? zziVar.zzbuj == null || zziVar.zzbuj.isEmpty() : this.zzbuj.equals(zziVar.zzbuj);
        }
        ...
        public final zzi mergeFrom(zzsm zzsmVar) throws zzst {
            while (true) {
                int iZzIX = zzsmVar.zzIX();
                switch (iZzIX) {
                    case 0:
    ...
    public final class zzj extends zzso {
        public zzi[] zzjt;
        public zzf zzju;
        public String zzjv;
        ...
        public static zzj zzd(byte[] bArr) {
        ...
        public final boolean equals(Object obj) {
            ...
            return (this.zzbuj == null || this.zzbuj.isEmpty()) ? zzjVar.zzbuj == null || zzjVar.zzbuj.isEmpty() : this.zzbuj.equals(zzjVar.zzbuj);
        }
        ...
        public final zzj mergeFrom(zzsm zzsmVar) throws zzst {
            while (true) {
                int iZzIX = zzsmVar.zzIX();
                switch (iZzIX) {
                    case 0:
