...
public class zzlk {
    ...
    public zzlk(int i, int i2, String str, JSONObject jSONObject, int i3, int i4, List list, JSONObject jSONObject2, String str2, String str3, long j, String str4, zzlj zzljVar) {
        this.zzadd = i;
        this.zzade = i2;
        this.zzadf = str;
    ...
    private static List zzb(JSONArray jSONArray) {
        zzlo zzloVar;
