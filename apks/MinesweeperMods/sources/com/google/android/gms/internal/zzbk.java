...
public class zzbk {
    ...
    public class zza {
        ...
        public boolean equals(Object obj) {
            ...
            return ((zza) obj).value == this.value && ((zza) obj).zzty == this.zzty;
        }
    ...
    static void zza(int i, long j, String str, int i2, PriorityQueue priorityQueue) {
        zza zzaVar = new zza(j, str, i2);
        if ((priorityQueue.size() != i || ((zza) priorityQueue.peek()).value <= zzaVar.value) && !priorityQueue.contains(zzaVar)) {
    ...
    private static long zzb(String[] strArr, int i, int i2) {
        long jZzx = (zzbi.zzx(strArr[i]) + 2147483647L) % 1073807359;
        for (int i3 = i + 1; i3 < i + i2; i3++) {
            jZzx = (((jZzx * 16785407) % 1073807359) + ((zzbi.zzx(strArr[i3]) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZzx;
    }
}
