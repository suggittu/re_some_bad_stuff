...
public interface zzqo extends IInterface {
    ...
    public abstract class zza extends Binder implements zzqo {
        ...
        public static zzqo zzdK(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzqo)) ? new C0161zza(iBinder) : (zzqo) iInterfaceQueryLocalInterface;
        }
    ...
    void zza(int i, Bundle bundle, int i2, Intent intent);
}
