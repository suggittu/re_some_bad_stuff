...
public interface zzog extends IInterface {
    ...
    public abstract class zza extends Binder implements zzog {
        ...
        public static zzog zzbB(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzog)) ? new C0131zza(iBinder) : (zzog) iInterfaceQueryLocalInterface;
        }
    ...
    void zza(DailyTotalResult dailyTotalResult);
}
