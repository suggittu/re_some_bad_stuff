...
public class zzsp {
    ...
    private Object zzK(List list) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < list.size(); i++) {
            zzsw zzswVar = (zzsw) list.get(i);
        ...
        Object objCast = this.zzbuk.cast(Array.newInstance(this.zzbuk.getComponentType(), size));
    ...
    protected void zza(zzsw zzswVar, List list) {
        list.add(zzP(zzsm.zzD(zzswVar.zzbuv)));
    }

    void zza(Object obj, zzsn zzsnVar) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        if (this.zzbul) {
            zzc(obj, zzsnVar);
        } else {
            zzb(obj, zzsnVar);
    ...
    protected void zzc(Object obj, zzsn zzsnVar) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
        int length = Array.getLength(obj);
        for (int i = 0; i < length; i++) {
