...
public class zzlp {
    ...
    public static void zza(List list, JSONObject jSONObject) throws JSONException {
        try {
            list.clear();
    ...
    public static void zza(JSONObject jSONObject, List list) throws JSONException {
    ...
    public static Calendar zzco(String str) {
        ...
        if (!TextUtils.isEmpty(strZzcq)) {
            ...
            str2 = strZzcq.length() == 6 ? "yyyyMMdd'T'HHmmss" : zzaeD;
        }
        ...
        try {
            ...
            switch (strSubstring.charAt(6)) {
                ...
                case Place.TYPE_SYNAGOGUE /* 90 */:
                    if (strSubstring.length() == zzaeC[0].length() + 6) {
                        break;
                    }
                    break;
            }
    ...
    private static boolean zzcr(String str) {
        ...
        return length == zzaeC[1].length() + 6 || length == zzaeC[2].length() + 6 || length == zzaeC[3].length() + 6;
    }
}
