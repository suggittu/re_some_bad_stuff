...
public final class zzer implements zzes.zza {
    ...
    public zzer(Context context, String str, zzex zzexVar, zzeo zzeoVar, zzen zzenVar, AdRequestParcel adRequestParcel, AdSizeParcel adSizeParcel, VersionInfoParcel versionInfoParcel, boolean z, boolean z2, NativeAdOptionsParcel nativeAdOptionsParcel, List list) {
    ...
    public boolean zzs(int i) {
        try {
            Bundle bundleZzeI = this.zzsA ? this.zzCi.zzeI() : this.zzCh.zzui ? this.zzCi.getInterstitialAdapterInfo() : this.zzCi.zzeH();
            return bundleZzeI != null && (bundleZzeI.getInt("capabilities", 0) & i) == i;
        } catch (RemoteException e) {
