...
public interface zzcu extends IInterface {
    ...
    public abstract class zza extends Binder implements zzcu {
        ...
        public static zzcu zzC(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcu)) ? new C0087zza(iBinder) : (zzcu) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(zzcp.zza.zzy(parcel.readStrongBinder()));
