...
public interface zzsz {
    ...
    public final class zzb extends zzso {
        ...
        public final void writeTo(zzsn zzsnVar) throws zzsn.zza {
            if (this.zzbuM != 0) {
                zzsnVar.zzA(1, this.zzbuM);
            }
            if (!this.zzbuN.equals("")) {
                zzsnVar.zzn(2, this.zzbuN);
            }
            if (!this.version.equals("")) {
                zzsnVar.zzn(3, this.version);
            }
            super.writeTo(zzsnVar);
        }
    ...
    public final class zzd extends zzso {
        ...
        public final void writeTo(zzsn zzsnVar) throws zzsn.zza {
            if (this.zzbuR != 0) {
                zzsnVar.zzb(1, this.zzbuR);
            }
            if (!this.tag.equals("")) {
                zzsnVar.zzn(2, this.tag);
            }
            ...
            if (!Arrays.equals(this.zzbuY, zzsx.zzbuD)) {
                zzsnVar.zza(6, this.zzbuY);
            }
            if (this.zzbvb != null) {
                zzsnVar.zza(7, this.zzbvb);
            }
            if (!Arrays.equals(this.zzbuZ, zzsx.zzbuD)) {
                zzsnVar.zza(8, this.zzbuZ);
            }
            if (this.zzbuX != null) {
                zzsnVar.zza(9, this.zzbuX);
            }
            if (this.zzbuV) {
                zzsnVar.zze(10, this.zzbuV);
            }
            if (this.zzbuU != 0) {
                zzsnVar.zzA(11, this.zzbuU);
            }
            if (this.zzob != 0) {
                zzsnVar.zzA(12, this.zzob);
            }
            if (!Arrays.equals(this.zzbva, zzsx.zzbuD)) {
                zzsnVar.zza(13, this.zzbva);
            }
            if (!this.zzbvc.equals("")) {
                zzsnVar.zzn(14, this.zzbvc);
            }
            if (this.zzbvd != 180000) {
                zzsnVar.zzc(15, this.zzbvd);
            }
            if (this.zzbve != null) {
                zzsnVar.zza(16, this.zzbve);
            }
            if (this.zzbuS != 0) {
                zzsnVar.zzb(17, this.zzbuS);
            }
            if (!Arrays.equals(this.zzbvf, zzsx.zzbuD)) {
                zzsnVar.zza(18, this.zzbvf);
            }
            if (this.zzbvg != 0) {
                zzsnVar.zzA(19, this.zzbvg);
            }
            if (this.zzbvh != null && this.zzbvh.length > 0) {
                for (int i2 = 0; i2 < this.zzbvh.length; i2++) {
                    zzsnVar.zzA(20, this.zzbvh[i2]);
                }
            }
            if (this.zzbuT != 0) {
                zzsnVar.zzb(21, this.zzbuT);
            }
            if (this.zzbvi != 0) {
                zzsnVar.zzb(22, this.zzbvi);
            }
            super.writeTo(zzsnVar);
        }
