...
public class zzaq {
    ...
    public byte[] zzc(byte[] bArr, String str) throws NoSuchPaddingException, NoSuchAlgorithmException, zza, InvalidKeyException, InvalidAlgorithmParameterException {
        if (bArr.length != 16) {
            throw new zza();
        }
        try {
