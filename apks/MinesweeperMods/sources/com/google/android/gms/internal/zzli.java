...
public class zzli extends com.google.android.gms.cast.internal.zzc {
    ...
    final class zzd implements GameManagerClient.GameManagerInstanceResult {
    ...
    final class zze implements GameManagerClient.GameManagerResult {
        private final Status zzUX;
    ...
    public zzli(GoogleApiClient googleApiClient, String str, Cast.CastApi castApi) {
    ...
    public void zza(String str, int i, JSONObject jSONObject, com.google.android.gms.cast.internal.zzo zzoVar) throws JSONException {
        ...
        zzW(true);
        this.zzacC.sendMessage(this.zzacD, getNamespace(), jSONObjectZza.toString()).setResultCallback(new ResultCallback() { // from class: com.google.android.gms.internal.zzli.4
    ...
    private void zzb(long j, int i, Object obj) {
        ...
        while (it.hasNext()) {
            if (((com.google.android.gms.cast.internal.zzp) it.next()).zzc(j, i, obj)) {
                it.remove();
            }
        }
    }
    ...
    private synchronized void zznR() {
        if (!isInitialized()) {
    ...
    public synchronized void sendGameMessage(String str, JSONObject jSONObject) {
        ...
        long j = 1 + this.zzacK;
        this.zzacK = j;
        JSONObject jSONObjectZza = zza(j, str, 7, jSONObject);
        if (jSONObjectZza != null) {
    ...
    public synchronized String zzce(String str) {
    ...
    protected boolean zzz(long j) {
        ...
        Iterator it = this.zzacA.iterator();
        while (it.hasNext()) {
            if (((com.google.android.gms.cast.internal.zzp) it.next()).zzd(j, 15)) {
                it.remove();
            }
        }
        synchronized (com.google.android.gms.cast.internal.zzp.zzaeB) {
            ...
            while (true) {
                ...
                if (((com.google.android.gms.cast.internal.zzp) it2.next()).zzoA()) {
                    z = true;
                    break;
                }
            }
