...
public interface zzla extends IInterface {
    ...
    public abstract class zza extends Binder implements zzla {
        ...
        public static zzla zzaz(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzla)) ? new C0118zza(iBinder) : (zzla) iInterfaceQueryLocalInterface;
        }
