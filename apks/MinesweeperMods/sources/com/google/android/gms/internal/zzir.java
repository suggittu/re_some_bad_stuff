...
public class zzir {
    ...
    public JSONObject zzG(Map map) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public boolean zzI(Context context) {
        ...
        if ((resolveInfoResolveActivity.activityInfo.configChanges & 128) == 0) {
            zzin.zzaK(String.format("com.google.android.gms.ads.AdActivity requires the android:configChanges value to contain \"%s\".", "orientation"));
            z = false;
        }
    ...
    public String zzN(Context context) throws SecurityException {
    ...
    */
    public boolean zzO(android.content.Context r7) {
        /*
            r6 = this;
            r2 = 0
        ...
        L4d:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzir.zzO(android.content.Context):boolean");
    }
    ...
    public void zza(Context context, String str, List list) {
        ...
        while (it.hasNext()) {
            new zziy(context, str, (String) it.next()).zzgd();
        }
    }

    public void zza(Context context, String str, List list, String str2) {
        Iterator it = list.iterator();
        while (it.hasNext()) {
            new zziy(context, str, (String) it.next(), str2).zzgd();
        }
    }
    ...
    public Bitmap zzf(Context context, String str) throws IOException {
    ...
    public String zzhs() throws NoSuchAlgorithmException {
