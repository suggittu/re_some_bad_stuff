...
public interface zzpp extends IInterface {
    ...
    public abstract class zza extends Binder implements zzpp {

        /* renamed from: com.google.android.gms.internal.zzpp$zza$zza, reason: collision with other inner class name */
        class C0153zza implements zzpp {
            ...
            public void zza(zzpo zzpoVar, UserAddressRequest userAddressRequest, Bundle bundle) {
        ...
        public static zzpp zzcc(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzpp)) ? new C0153zza(iBinder) : (zzpp) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 2:
                    ...
                    zza(zzpo.zza.zzcb(parcel.readStrongBinder()), parcel.readInt() != 0 ? (UserAddressRequest) UserAddressRequest.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
    ...
    void zza(zzpo zzpoVar, UserAddressRequest userAddressRequest, Bundle bundle);
}
