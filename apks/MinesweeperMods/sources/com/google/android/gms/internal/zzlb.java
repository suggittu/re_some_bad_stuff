...
public interface zzlb extends IInterface {
    ...
    public abstract class zza extends Binder implements zzlb {
        ...
        class C0119zza implements zzlb {
            ...
            public void zza(zzla zzlaVar, ProxyGrpcRequest proxyGrpcRequest) {
            ...
            @Override // com.google.android.gms.internal.zzlb
            public void zza(zzla zzlaVar, ProxyRequest proxyRequest) {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.auth.api.internal.IAuthService");
        ...
        public static zzlb zzaA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzlb)) ? new C0119zza(iBinder) : (zzlb) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(zzla.zza.zzaz(parcel.readStrongBinder()), parcel.readInt() != 0 ? (ProxyRequest) ProxyRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.auth.api.internal.IAuthService");
                    zza(zzla.zza.zzaz(parcel.readStrongBinder()), parcel.readInt() != 0 ? (ProxyGrpcRequest) ProxyGrpcRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(zzla zzlaVar, ProxyGrpcRequest proxyGrpcRequest);

    void zza(zzla zzlaVar, ProxyRequest proxyRequest);
}
