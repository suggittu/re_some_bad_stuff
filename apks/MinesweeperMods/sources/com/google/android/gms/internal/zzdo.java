...
public final class zzdo implements zzdf {
    private final Map zzzI = new WeakHashMap();

    private static int zza(Context context, Map map, String str, int i) {
    ...
    public final void zza(zzjp zzjpVar, Map map) throws NumberFormatException {
        ...
        if (zEquals || zEquals2) {
            ...
            if (this.zzzI.containsKey(zzjpVar)) {
                int iIntValue = ((Integer) this.zzzI.get(zzjpVar)).intValue();
        ...
        if ("mimetype".equals(str)) {
            zzkVarZzhM3.setMimeType((String) map.get("mimetype"));
            return;
        }
        if ("muted".equals(str)) {
        ...
        if ("src".equals(str)) {
            zzkVarZzhM3.zzap((String) map.get("src"));
            return;
        }
