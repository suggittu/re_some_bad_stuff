...
public class zzdg implements zzdf {
    ...
    class zzb {
        ...
        private final ArrayList zzzr;
        private final String zzzs;

        public zzb(String str, URL url, ArrayList arrayList, String str2) {
            this.zzzp = str;
            this.zzzq = url;
            if (arrayList == null) {
    ...
    class zzd {
        ...
        public zzd(String str, int i, List list, String str2) {
            this.zzzp = str;
            this.zzzw = i;
            if (list == null) {
    ...
    public JSONObject zzQ(String str) throws JSONException {
        try {
    ...
    protected zzc zza(zzb zzbVar) {
        try {
            ...
            Iterator it = zzbVar.zzdW().iterator();
            while (it.hasNext()) {
    ...
    public void zza(final zzjp zzjpVar, final Map map) {
