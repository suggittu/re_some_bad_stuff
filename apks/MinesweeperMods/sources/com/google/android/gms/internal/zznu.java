...
public class zznu {
    ...
    public static final Set AGGREGATE_INPUT_TYPES = Collections.unmodifiableSet(new HashSet(Arrays.asList(zzayD.name, zzayF.name, zzayG.name, zzayQ.name, zzayE.name, zzayN.name, zzayO.name, zzazc.name, zzayS.name, zzayA.name, zzayY.name)));
    ...
    private static final Map zzawC = zzuF();
    ...
    private static void zza(Map map, Collection collection, zza zzaVar) {
        Iterator it = collection.iterator();
        while (it.hasNext()) {
            map.put((zzsy.zza) it.next(), zzaVar);
        }
    }
