...
public class zzrf extends com.google.android.gms.common.internal.zzj {
    ...
    public void zza(zzrc zzrcVar, List list, int i, String str) {
        int[] iArr = new int[list.size()];
        int i2 = 0;
        while (true) {
            int i3 = i2;
            if (i3 >= list.size()) {
                ((zzrd) zzqJ()).zza(zzrcVar, zznn(), iArr, i, str);
                return;
            } else {
