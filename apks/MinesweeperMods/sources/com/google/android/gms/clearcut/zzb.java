...
public final class zzb {
    ...
    public static final Api.zza zzUJ = new Api.zza() { // from class: com.google.android.gms.clearcut.zzb.1
        @Override // com.google.android.gms.common.api.Api.zza
        /* renamed from: zze, reason: merged with bridge method [inline-methods] */
        public final zzlw zza(Context context, Looper looper, zzf zzfVar, Api.ApiOptions.NoOptions noOptions, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public class zza {
        ...
        private String zzaeV;
        private int zzaeX;
        private final InterfaceC0035zzb zzafb;
        private InterfaceC0035zzb zzafc;
        private ArrayList zzafd;
        private final zzsz.zzd zzafe;
        private boolean zzaff;

        private zza(zzb zzbVar, byte[] bArr) {
            this(bArr, (InterfaceC0035zzb) null);
        }

        private zza(byte[] bArr, InterfaceC0035zzb interfaceC0035zzb) {
        ...
        public PendingResult zzd(GoogleApiClient googleApiClient) {
            if (this.zzaff) {
    ...
    public interface InterfaceC0035zzb {
        byte[] zzoF();
    }
    ...
    public final boolean zza(GoogleApiClient googleApiClient, long j, TimeUnit timeUnit) {
