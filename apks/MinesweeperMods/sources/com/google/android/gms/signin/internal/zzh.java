...
public class zzh extends com.google.android.gms.common.internal.zzj implements zzrn {
    ...
    public void zza(zzp zzpVar, boolean z) {
        try {
            ((zze) zzqJ()).zza(zzpVar, this.zzale.intValue(), z);
        } catch (RemoteException e) {
    ...
    public void zza(zzd zzdVar) {
        ...
        try {
            ((zze) zzqJ()).zza(new SignInRequest(zzFN()), zzdVar);
        } catch (RemoteException e) {
