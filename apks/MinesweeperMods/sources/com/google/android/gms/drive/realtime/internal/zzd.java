...
public interface zzd extends IInterface {
    ...
    public abstract class zza extends Binder implements zzd {
        ...
        public static zzd zzbf(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzd)) ? new C0052zza(iBinder) : (zzd) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? (ParcelableCollaborator) ParcelableCollaborator.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.drive.realtime.internal.ICollaboratorEventCallback");
                    zzb(parcel.readInt() != 0 ? (ParcelableCollaborator) ParcelableCollaborator.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zza(ParcelableCollaborator parcelableCollaborator);

    void zzb(ParcelableCollaborator parcelableCollaborator);
}
