...
public interface zzk extends IInterface {
    ...
    public abstract class zza extends Binder implements zzk {
        ...
        public static zzk zzbm(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzk)) ? new C0059zza(iBinder) : (zzk) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? (ParcelableIndexReference) ParcelableIndexReference.CREATOR.createFromParcel(parcel) : null);
    ...
    void zza(ParcelableIndexReference parcelableIndexReference);
}
