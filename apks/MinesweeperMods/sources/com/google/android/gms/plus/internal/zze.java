...
public class zze extends zzj {
    ...
    final class zza implements Moments.LoadMomentsResult {
    ...
    final class zzb implements People.LoadPeopleResult {
        private final Status zzUX;
        private final String zzbek;
    ...
    final class zzc extends com.google.android.gms.plus.internal.zza {
    ...
    final class zzd extends com.google.android.gms.plus.internal.zza {
        private final zza.zzb zzaON;
    ...
    final class BinderC0257zze extends com.google.android.gms.plus.internal.zza {
        private final zza.zzb zzaON;

        public BinderC0257zze(zza.zzb zzbVar) {
            this.zzaON = zzbVar;
        }
    ...
    final class zzf extends com.google.android.gms.plus.internal.zza {
        private final zza.zzb zzaON;
    ...
    public String getAccountName() {
        zzqI();
        try {
            return ((com.google.android.gms.plus.internal.zzd) zzqJ()).getAccountName();
    ...
    public void zzEY() {
        ...
        try {
            this.zzbei = null;
            ((com.google.android.gms.plus.internal.zzd) zzqJ()).zzEY();
        } catch (RemoteException e) {
            throw new IllegalStateException(e);
        }
    }
    ...
    public zzq zza(zza.zzb zzbVar, int i, String str) {
        zzqI();
        BinderC0257zze binderC0257zze = new BinderC0257zze(zzbVar);
        try {
            return ((com.google.android.gms.plus.internal.zzd) zzqJ()).zza(binderC0257zze, 1, i, -1, str);
        } catch (RemoteException e) {
            binderC0257zze.zza(DataHolder.zzbI(8), (String) null);
            return null;
        }
    }
    ...
    public void zza(zza.zzb zzbVar, int i, String str, Uri uri, String str2, String str3) {
        ...
        try {
            ((com.google.android.gms.plus.internal.zzd) zzqJ()).zza(zzdVar, i, str, uri, str2, str3);
        } catch (RemoteException e) {
    ...
    public void zza(zza.zzb zzbVar, Moment moment) {
        ...
        try {
            ((com.google.android.gms.plus.internal.zzd) zzqJ()).zza(zzcVar, SafeParcelResponse.zza((MomentEntity) moment));
        } catch (RemoteException e) {
            if (zzcVar == null) {
                throw new IllegalStateException(e);
            }
    ...
    public void zza(zza.zzb zzbVar, Collection collection) {
        ...
        BinderC0257zze binderC0257zze = new BinderC0257zze(zzbVar);
        try {
            ((com.google.android.gms.plus.internal.zzd) zzqJ()).zza(binderC0257zze, new ArrayList(collection));
        } catch (RemoteException e) {
            binderC0257zze.zza(DataHolder.zzbI(8), (String) null);
        }
    }
    ...
    public void zzfG(String str) {
        zzqI();
        try {
            ((com.google.android.gms.plus.internal.zzd) zzqJ()).zzfG(str);
        } catch (RemoteException e) {
            throw new IllegalStateException(e);
        }
    }
    ...
    public void zzp(zza.zzb zzbVar) {
        zzqI();
        BinderC0257zze binderC0257zze = new BinderC0257zze(zzbVar);
        try {
            ((com.google.android.gms.plus.internal.zzd) zzqJ()).zza(binderC0257zze, 2, 1, -1, null);
        } catch (RemoteException e) {
            binderC0257zze.zza(DataHolder.zzbI(8), (String) null);
        }
    }

    public zzq zzq(zza.zzb zzbVar, String str) {
        return zza(zzbVar, 0, str);
    }

    public void zzq(zza.zzb zzbVar) {
        zzqI();
        zzEY();
        zzf zzfVar = new zzf(zzbVar);
        try {
            ((com.google.android.gms.plus.internal.zzd) zzqJ()).zzb(zzfVar);
        } catch (RemoteException e) {
            zzfVar.zzi(8, null);
        }
    }
