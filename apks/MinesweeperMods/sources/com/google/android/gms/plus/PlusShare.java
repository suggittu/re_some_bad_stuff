    ...
    public class Builder {
        ...
        public Builder addCallToAction(String str, Uri uri, String str2) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                zzx.zza(PlusShare.zzfD(str2), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            if (!z2 && zEquals) {
                ...
                if (this.zzbeh == null || this.zzbeh.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", (Parcelable) this.zzbeh.get(0));
                }
                this.zzbeh = null;
            }
            if (z2 && !zEquals) {
        ...
        public Builder setContentDeepLinkId(String str, String str2, String str3, Uri uri) {
            ...
            zzx.zzb(!TextUtils.isEmpty(str), "The deepLinkId parameter is required.");
            Bundle bundleZza = PlusShare.zza(str2, str3, uri);
