...
public class zzaf extends zzd {
    ...
    public synchronized void zzb(int i, String str, Object obj, Object obj2, Object obj3) {
        synchronized (this) {
            ...
            int i2 = i >= 0 ? i : 0;
            String strSubstring = zzSW + zzSX.charAt(i2 >= zzSX.length() ? zzSX.length() - 1 : i2) + (zzjn().zzks() ? zzjn().zzkr() ? 'P' : 'C' : zzjn().zzkr() ? 'p' : 'c') + zze.VERSION + ":" + zzc(str, zzl(obj), zzl(obj2), zzl(obj3));
    ...
    public void zzh(Map map, String str) {
        String string;
        if (str == null) {
            str = "no reason provided";
        }
