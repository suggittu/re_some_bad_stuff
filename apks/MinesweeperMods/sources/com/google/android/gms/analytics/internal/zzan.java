...
public class zzan extends zzd {
    ...
    protected void zziJ() throws PackageManager.NameNotFoundException {
        zzmd();
    }
    ...
    protected void zzmd() throws PackageManager.NameNotFoundException {
        ...
        if (bundle == null || (i = bundle.getInt("com.google.android.gms.analytics.globalConfigResource")) <= 0 || (zzaaVar = (zzaa) new zzz(zzji()).zzah(i)) == null) {
            return;
        }
        zza(zzaaVar);
    }
