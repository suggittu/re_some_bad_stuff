...
public final class AnalyticsService extends Service {
    ...
    public static boolean zzZ(Context context) {
        ...
        boolean zZza = zzam.zza(context, AnalyticsService.class);
    ...
    public final int onStartCommand(Intent intent, int i, final int i2) {
        ...
        if (zzfVarZzaa.zzjn().zzkr()) {
            zzafVarZzjm.zza("Device AnalyticsService called. startId, action", Integer.valueOf(i2), action);
        } else {
            zzafVarZzjm.zza("Local AnalyticsService called. startId, action", Integer.valueOf(i2), action);
        }
