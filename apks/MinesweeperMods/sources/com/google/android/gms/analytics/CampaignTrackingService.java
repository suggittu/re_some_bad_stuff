...
public class CampaignTrackingService extends Service {
    ...
    public static boolean zzZ(Context context) {
        ...
        boolean zZza = zzam.zza(context, CampaignTrackingService.class);
    ...
    public int onStartCommand(Intent intent, int i, final int i2) {
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            ...
            zzfVarZzaa.zzjo().zzf(new Runnable() { // from class: com.google.android.gms.analytics.CampaignTrackingService.1
                ...
                public void run() {
                    CampaignTrackingService.this.zza(zzafVarZzjm, handler, i2);
                }
            });
        } else {
            ...
            zzafVarZzjm.zza("CampaignTrackingService called. startId, campaign", Integer.valueOf(i2), stringExtra);
