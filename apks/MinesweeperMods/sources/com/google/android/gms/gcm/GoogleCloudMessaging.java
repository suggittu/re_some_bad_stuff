...
public class GoogleCloudMessaging {
    ...
    final Messenger zzaLU = new Messenger(new Handler(Looper.getMainLooper()) { // from class: com.google.android.gms.gcm.GoogleCloudMessaging.1
        ...
        public void handleMessage(Message message) {
            ...
            if ("com.google.android.c2dm.intent.REGISTRATION".equals(intent.getAction())) {
                ...
                if (GoogleCloudMessaging.this.zzr(intent)) {
                    return;
                }
    ...
    public static synchronized GoogleCloudMessaging getInstance(Context context) {
        if (zzaLP == null) {
            ...
            googleCloudMessaging.context = context.getApplicationContext();
        }
        return zzaLP;
    }
    ...
    public boolean zzr(Intent intent) {
        ...
        if (stringExtra == null || (handler = (Handler) this.zzaLR.remove(stringExtra)) == null) {
            return false;
        }
        Message messageObtain = Message.obtain();
        messageObtain.obj = intent;
        return handler.sendMessage(messageObtain);
    }
    ...
    public synchronized String register(String... strArr) {
        ...
        if (zzaJ(this.context).contains(".gsf")) {
            ...
            strZza = zza(zzE(bundle), "registration_id");
        }
        return strZza;
    }
    ...
    Intent zzE(Bundle bundle) throws IOException {
        ...
        try {
            return (Intent) this.zzaLT.poll(30000L, TimeUnit.MILLISECONDS);
