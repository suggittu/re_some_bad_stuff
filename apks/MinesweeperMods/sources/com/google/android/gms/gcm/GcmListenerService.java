...
public abstract class GcmListenerService extends Service {
    ...
    private void zzm(Intent intent) throws PendingIntent.CanceledException {
    ...
    private void zzn(final Intent intent) {
        if (Build.VERSION.SDK_INT >= 11) {
            ...
            new AsyncTask() { // from class: com.google.android.gms.gcm.GcmListenerService.2
    ...
    @Override // android.app.Service
    public final int onStartCommand(Intent intent, int i, int i2) throws PendingIntent.CanceledException {
        synchronized (this.zzpV) {
            this.zzaLy = i2;
            this.zzaLz++;
        }
