...
public class zzk implements Parcelable.Creator {
    static void zza(Barcode.Sms sms, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zzc(parcel, 1, sms.versionCode);
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 2, sms.message, false);
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 3, sms.phoneNumber, false);
    ...
    public Barcode.Sms createFromParcel(Parcel parcel) {
        ...
        return new Barcode.Sms(iZzg, strZzp2, strZzp);
    }
