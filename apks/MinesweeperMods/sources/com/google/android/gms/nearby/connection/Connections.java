...
public interface Connections {
    ...
    public static final List zzbba = zzmr.zzc(1, 2);
    ...
    PendingResult acceptConnectionRequest(GoogleApiClient googleApiClient, String str, byte[] bArr, MessageListener messageListener);
    ...
    PendingResult rejectConnectionRequest(GoogleApiClient googleApiClient, String str);

    PendingResult sendConnectionRequest(GoogleApiClient googleApiClient, String str, String str2, byte[] bArr, ConnectionResponseCallback connectionResponseCallback, MessageListener messageListener);

    void sendReliableMessage(GoogleApiClient googleApiClient, String str, byte[] bArr);

    void sendReliableMessage(GoogleApiClient googleApiClient, List list, byte[] bArr);

    void sendUnreliableMessage(GoogleApiClient googleApiClient, String str, byte[] bArr);

    void sendUnreliableMessage(GoogleApiClient googleApiClient, List list, byte[] bArr);

    PendingResult startAdvertising(GoogleApiClient googleApiClient, String str, AppMetadata appMetadata, long j, ConnectionRequestListener connectionRequestListener);

    PendingResult startDiscovery(GoogleApiClient googleApiClient, String str, long j, EndpointDiscoveryListener endpointDiscoveryListener);
