...
public interface zzf extends IInterface {
    ...
    public abstract class zza extends Binder implements zzf {
        ...
        class C0243zza implements zzf {
            ...
            @Override // com.google.android.gms.nearby.messages.internal.zzf
            public void zza(HandleClientLifecycleEventRequest handleClientLifecycleEventRequest) {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.nearby.messages.internal.INearbyMessagesService");
            ...
            @Override // com.google.android.gms.nearby.messages.internal.zzf
            public void zza(RegisterStatusCallbackRequest registerStatusCallbackRequest) {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.nearby.messages.internal.INearbyMessagesService");
        ...
        public static zzf zzdA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzf)) ? new C0243zza(iBinder) : (zzf) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? (PublishRequest) PublishRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.nearby.messages.internal.INearbyMessagesService");
                    zza(parcel.readInt() != 0 ? (UnpublishRequest) UnpublishRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.nearby.messages.internal.INearbyMessagesService");
                ...
                case 7:
                    parcel.enforceInterface("com.google.android.gms.nearby.messages.internal.INearbyMessagesService");
                    zza(parcel.readInt() != 0 ? (GetPermissionStatusRequest) GetPermissionStatusRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 8:
                    parcel.enforceInterface("com.google.android.gms.nearby.messages.internal.INearbyMessagesService");
                    zza(parcel.readInt() != 0 ? (RegisterStatusCallbackRequest) RegisterStatusCallbackRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 9:
                    parcel.enforceInterface("com.google.android.gms.nearby.messages.internal.INearbyMessagesService");
                    zza(parcel.readInt() != 0 ? (HandleClientLifecycleEventRequest) HandleClientLifecycleEventRequest.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
