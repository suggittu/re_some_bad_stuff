...
public interface zzc extends IInterface {
    ...
    public abstract class zza extends Binder implements zzc {
        ...
        class C0250zza implements zzc {
            private IBinder zzoz;

            C0250zza(IBinder iBinder) {
                this.zzoz = iBinder;
            }
        ...
        public static zzc zzdH(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzc)) ? new C0250zza(iBinder) : (zzc) iInterfaceQueryLocalInterface;
        }
