...
public interface zzk extends IInterface {
    ...
    public abstract class zza extends Binder implements zzk {
        ...
        public static zzk zzcG(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzk)) ? new C0211zza(iBinder) : (zzk) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zzu(zzd.zza.zzbs(parcel.readStrongBinder()));
    ...
    void zzu(com.google.android.gms.dynamic.zzd zzdVar);
}
