...
public interface zzv extends IInterface {
    ...
    public abstract class zza extends Binder implements zzv {
        ...
        public static zzv zzcR(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzv)) ? new C0222zza(iBinder) : (zzv) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(IPolylineDelegate.zza.zzdk(parcel.readStrongBinder()));
