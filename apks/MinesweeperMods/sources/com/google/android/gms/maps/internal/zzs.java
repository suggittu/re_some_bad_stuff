...
public interface zzs extends IInterface {
    ...
    public abstract class zza extends Binder implements zzs {
        ...
        public static zzs zzcO(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzs)) ? new C0219zza(iBinder) : (zzs) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zzq(zzd.zza.zzbs(parcel.readStrongBinder()));
