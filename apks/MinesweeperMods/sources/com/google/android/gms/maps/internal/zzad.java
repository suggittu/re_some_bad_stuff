...
public class zzad {
    ...
    private static Context getRemoteContext(Context context) {
        if (zzaSU == null) {
            if (zzAg()) {
                zzaSU = context.getApplicationContext();
            } else {
                zzaSU = GooglePlayServicesUtil.getRemoteContext(context);
            }
        }
        return zzaSU;
    }
    ...
    private static Object zza(ClassLoader classLoader, String str) {
        try {
            return zzd(((ClassLoader) com.google.android.gms.common.internal.zzx.zzz(classLoader)).loadClass(str));
        } catch (ClassNotFoundException e) {
    ...
    public static zzc zzaO(Context context) throws GooglePlayServicesNotAvailableException {
        ...
        zzaSV = zzaQ(context);
        try {
            zzaSV.zzd(com.google.android.gms.dynamic.zze.zzC(getRemoteContext(context).getResources()), GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            return zzaSV;
