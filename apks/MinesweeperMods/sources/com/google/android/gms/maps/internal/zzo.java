...
public interface zzo extends IInterface {
    ...
    public abstract class zza extends Binder implements zzo {
        ...
        public static zzo zzcK(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzo)) ? new C0215zza(iBinder) : (zzo) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    zza(IGoogleMapDelegate.zza.zzcv(parcel.readStrongBinder()));
