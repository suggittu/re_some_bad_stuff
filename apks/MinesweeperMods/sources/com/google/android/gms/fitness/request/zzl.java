...
public class zzl implements Parcelable.Creator {
    static void zza(DataUpdateListenerUnregistrationRequest dataUpdateListenerUnregistrationRequest, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 1, (Parcelable) dataUpdateListenerUnregistrationRequest.getIntent(), i, false);
        com.google.android.gms.common.internal.safeparcel.zzb.zzc(parcel, 1000, dataUpdateListenerUnregistrationRequest.getVersionCode());
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 2, dataUpdateListenerUnregistrationRequest.getCallbackBinder(), false);
    ...
    public DataUpdateListenerUnregistrationRequest createFromParcel(Parcel parcel) {
        ...
        return new DataUpdateListenerUnregistrationRequest(iZzg, pendingIntent, iBinderZzq);
    }
