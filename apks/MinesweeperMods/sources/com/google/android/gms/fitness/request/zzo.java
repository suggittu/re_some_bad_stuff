...
public class zzo implements Parcelable.Creator {
    static void zza(DisableFitRequest disableFitRequest, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 1, disableFitRequest.getCallbackBinder(), false);
    ...
    public DisableFitRequest createFromParcel(Parcel parcel) {
        ...
        return new DisableFitRequest(iZzg, iBinderZzq);
    }
