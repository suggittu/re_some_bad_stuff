...
public class DataDeleteRequest implements SafeParcelable {
    ...
    DataDeleteRequest(int i, long j, long j2, List list, List list2, List list3, boolean z, boolean z2, IBinder iBinder) {
        this.mVersionCode = i;
        this.zzRD = j;
        this.zzavV = j2;
    ...
    public DataDeleteRequest(long j, long j2, List list, List list2, List list3, boolean z, boolean z2, zzow zzowVar) {
        this.mVersionCode = 3;
        this.zzRD = j;
        this.zzavV = j2;
        this.zzaAF = Collections.unmodifiableList(list);
    ...
    public DataDeleteRequest(DataDeleteRequest dataDeleteRequest, zzow zzowVar) {
        this(dataDeleteRequest.zzRD, dataDeleteRequest.zzavV, dataDeleteRequest.zzaAF, dataDeleteRequest.zzawe, dataDeleteRequest.zzaAG, dataDeleteRequest.zzaAH, dataDeleteRequest.zzaAI, zzowVar);
    }
