...
public final class DataType implements SafeParcelable {
    ...
    public static final Set AGGREGATE_INPUT_TYPES = zzmr.zzc(TYPE_STEP_COUNT_DELTA, TYPE_DISTANCE_DELTA, TYPE_ACTIVITY_SEGMENT, zzawv, TYPE_SPEED, TYPE_HEART_RATE_BPM, TYPE_WEIGHT, TYPE_LOCATION_SAMPLE, TYPE_CALORIES_CONSUMED, TYPE_CALORIES_EXPENDED, TYPE_BODY_FAT_PERCENTAGE, zzawy, zzawx, TYPE_NUTRITION);
    ...
    static {
        ...
        zzawC = map;
        map.put(TYPE_ACTIVITY_SEGMENT, Collections.singletonList(AGGREGATE_ACTIVITY_SUMMARY));
    ...
    DataType(int i, String str, List list) {
        this.mVersionCode = i;
        this.mName = str;
    ...
    public static List getAggregatesForInput(DataType dataType) {
        List list = (List) zzawC.get(dataType);
