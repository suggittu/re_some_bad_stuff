...
public class zzp implements Parcelable.Creator {
    static void zza(GetSyncInfoRequest getSyncInfoRequest, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 1, getSyncInfoRequest.getCallbackBinder(), false);
    ...
    public GetSyncInfoRequest createFromParcel(Parcel parcel) {
        ...
        return new GetSyncInfoRequest(iZzg, iBinderZzq);
    }
