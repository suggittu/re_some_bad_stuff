...
public interface Requests {
    ...
    PendingResult acceptRequest(GoogleApiClient googleApiClient, String str);

    PendingResult acceptRequests(GoogleApiClient googleApiClient, List list);

    PendingResult dismissRequest(GoogleApiClient googleApiClient, String str);

    PendingResult dismissRequests(GoogleApiClient googleApiClient, List list);

    ArrayList getGameRequestsFromBundle(Bundle bundle);

    ArrayList getGameRequestsFromInboxResponse(Intent intent);
    ...
    PendingResult loadRequests(GoogleApiClient googleApiClient, int i, int i2, int i3);
