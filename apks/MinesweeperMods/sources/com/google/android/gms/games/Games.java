...
public final class Games {
    ...
    private static final Api.zza zzUJ = new GamesClientBuilder() { // from class: com.google.android.gms.games.Games.1
        @Override // com.google.android.gms.common.api.Api.zza
        /* renamed from: zza, reason: merged with bridge method [inline-methods] */
        public final List zzo(GamesOptions gamesOptions) {
            return Collections.singletonList(Games.SCOPE_GAMES);
        }
    };
    private static final Api.zza zzaCv = new GamesClientBuilder() { // from class: com.google.android.gms.games.Games.2
        @Override // com.google.android.gms.common.api.Api.zza
        /* renamed from: zza, reason: merged with bridge method [inline-methods] */
        public final List zzo(GamesOptions gamesOptions) {
    ...
    final class AnonymousClass3 extends GetTokenImpl {
        ...
        protected final /* synthetic */ void zza(Api.zzb zzbVar) {
            ((GamesClientImpl) zzbVar).zzd(this);
        }

        protected final void zza(GamesClientImpl gamesClientImpl) {
    ...
    final class AnonymousClass6 extends BaseGamesApiMethodImpl {
        ...
        public final LoadExperimentsResult zzc(final Status status) {
        ...
        @Override // com.google.android.gms.common.api.internal.zza.AbstractC0036zza
        protected final /* synthetic */ void zza(Api.zzb zzbVar) {
            ((GamesClientImpl) zzbVar).zzl(this);
        }
    ...
    public abstract class BaseGamesApiMethodImpl extends zza.AbstractC0036zza {
    ...
    public final class GamesOptions implements Api.ApiOptions.Optional {
        ...
        public final class Builder {
            ...
            public final Builder setRequireGooglePlus(boolean z) {
                this.zzaCL = z;
                return this;
            }
    ...
    @Deprecated
    public static PendingResult getGamesServerAuthCode(GoogleApiClient googleApiClient, final String str) {
        zzx.zzh(str, "Please provide a valid serverClientId");
        return googleApiClient.zzb(new GetServerAuthCodeImpl(googleApiClient) { // from class: com.google.android.gms.games.Games.4
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.google.android.gms.common.api.internal.zza.AbstractC0036zza
            public final void zza(GamesClientImpl gamesClientImpl) {
    ...
    public static void setGravityForPopups(GoogleApiClient googleApiClient, int i) {
        GamesClientImpl gamesClientImplZzb = zzb(googleApiClient, false);
        if (gamesClientImplZzb != null) {
            gamesClientImplZzb.zzgs(i);
        }
    }
    ...
    public static void setViewForPopups(GoogleApiClient googleApiClient, View view) {
        ...
        GamesClientImpl gamesClientImplZzb = zzb(googleApiClient, false);
        if (gamesClientImplZzb != null) {
            gamesClientImplZzb.zzo(view);
        }
    }

    public static PendingResult signOut(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new SignOutImpl(googleApiClient) { // from class: com.google.android.gms.games.Games.5
            @Override // com.google.android.gms.common.api.internal.zza.AbstractC0036zza
            protected final /* synthetic */ void zza(Api.zzb zzbVar) {
                ((GamesClientImpl) zzbVar).zzf(this);
            }
