...
public interface Quests {
    ...
    public static final int[] SELECT_ALL_QUESTS = {1, 2, 3, 4, SELECT_COMPLETED_UNCLAIMED, 5, 102, 6, SELECT_RECENTLY_FAILED};
    ...
    PendingResult accept(GoogleApiClient googleApiClient, String str);

    PendingResult claim(GoogleApiClient googleApiClient, String str, String str2);
    ...
    PendingResult load(GoogleApiClient googleApiClient, int[] iArr, int i, boolean z);
