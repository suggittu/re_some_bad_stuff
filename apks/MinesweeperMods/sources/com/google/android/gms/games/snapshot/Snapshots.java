...
public interface Snapshots {
    ...
    PendingResult commitAndClose(GoogleApiClient googleApiClient, Snapshot snapshot, SnapshotMetadataChange snapshotMetadataChange);

    PendingResult delete(GoogleApiClient googleApiClient, SnapshotMetadata snapshotMetadata);
    ...
    PendingResult open(GoogleApiClient googleApiClient, SnapshotMetadata snapshotMetadata);

    PendingResult open(GoogleApiClient googleApiClient, SnapshotMetadata snapshotMetadata, int i);

    PendingResult open(GoogleApiClient googleApiClient, String str, boolean z);

    PendingResult open(GoogleApiClient googleApiClient, String str, boolean z, int i);

    PendingResult resolveConflict(GoogleApiClient googleApiClient, String str, Snapshot snapshot);

    PendingResult resolveConflict(GoogleApiClient googleApiClient, String str, String str2, SnapshotMetadataChange snapshotMetadataChange, SnapshotContents snapshotContents);
}
