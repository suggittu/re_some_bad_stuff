...
class zzc extends zzz {
    ...
    private Boolean zza(zzpz.zze zzeVar, zzqb.zzg zzgVar) throws NumberFormatException {
    ...
    zzqb.zza[] zza(String str, zzqb.zzb[] zzbVarArr, zzqb.zzg[] zzgVarArr) throws NumberFormatException {
        Map map;
        zzqb.zza zzaVar;
        zzi zziVarZzCB;
        Map map2;
        ...
        if (zzbVarArr != null) {
            ...
            while (true) {
                ...
                Map map3 = (Map) arrayMap4.get(zzbVar.name);
                if (map3 == null) {
                    Map mapZzL = zzCj().zzL(str, zzbVar.name);
                    if (mapZzL == null) {
                        mapZzL = new ArrayMap();
                    }
                ...
                while (it.hasNext()) {
                    ...
                    if (hashSet.contains(Integer.valueOf(iIntValue))) {
                        ...
                        List<zzpz.zzb> list = (List) map2.get(Integer.valueOf(iIntValue));
                        BitSet bitSet2 = (BitSet) arrayMap2.get(Integer.valueOf(iIntValue));
                        BitSet bitSet3 = (BitSet) arrayMap3.get(Integer.valueOf(iIntValue));
                        if (bitSet2 == null) {
                            BitSet bitSet4 = new BitSet();
                            arrayMap2.put(Integer.valueOf(iIntValue), bitSet4);
                            bitSet3 = new BitSet();
                            arrayMap3.put(Integer.valueOf(iIntValue), bitSet3);
                            bitSet = bitSet4;
                        } else {
                            bitSet = bitSet2;
                        }
        ...
        if (zzgVarArr != null) {
            ...
            for (zzqb.zzg zzgVar : zzgVarArr) {
                Map map4 = (Map) arrayMap5.get(zzgVar.name);
                if (map4 == null) {
                    Map mapZzM = zzCj().zzM(str, zzgVar.name);
                    if (mapZzM == null) {
                        mapZzM = new ArrayMap();
                    }
                ...
                while (it2.hasNext()) {
                    ...
                    if (hashSet.contains(Integer.valueOf(iIntValue2))) {
                        ...
                        List<zzpz.zze> list2 = (List) map.get(Integer.valueOf(iIntValue2));
                        BitSet bitSet5 = (BitSet) arrayMap2.get(Integer.valueOf(iIntValue2));
                        BitSet bitSet6 = (BitSet) arrayMap3.get(Integer.valueOf(iIntValue2));
                        if (bitSet5 == null) {
                            bitSet5 = new BitSet();
                            arrayMap2.put(Integer.valueOf(iIntValue2), bitSet5);
                            bitSet6 = new BitSet();
                            arrayMap3.put(Integer.valueOf(iIntValue2), bitSet6);
                        }
                        ...
                        for (zzpz.zze zzeVar : list2) {
                            ...
                            if (bitSet6.get(zzeVar.zzaZv.intValue())) {
                                ...
                                if (boolZza2 == null) {
                                    ...
                                    bitSet6.set(zzeVar.zzaZv.intValue());
                                    if (boolZza2.booleanValue()) {
                                        bitSet5.set(zzeVar.zzaZv.intValue());
                                    }
                                }
                            }
                        }
