...
public class zzq extends zzz {
    ...
    class zzc implements Runnable {
        ...
        public void run() throws Throwable {
            ...
            try {
                ...
                try {
                    if (this.zzaWU != null) {
                        for (Map.Entry entry : this.zzaWU.entrySet()) {
                            httpURLConnectionZzc.addRequestProperty((String) entry.getKey(), (String) entry.getValue());
                        }
                    }
                    if (this.zzaWS != null) {
                        ...
                        try {
                            ...
                            zzq.this.zzCn().zzg(new zzb(this.zzTJ, this.zzaWT, i, e, bArr));
                            return;
                        } catch (Throwable th2) {
                            th = th2;
                            if (outputStream != null) {
                            ...
                            zzq.this.zzCn().zzg(new zzb(this.zzTJ, this.zzaWT, responseCode, objArr5 == true ? 1 : 0, objArr4 == true ? 1 : 0));
                            throw th;
                        }
                    }
                    ...
                    zzq.this.zzCn().zzg(new zzb(this.zzTJ, this.zzaWT, responseCode, objArr2 == true ? 1 : 0, bArrZzc));
    ...
    @WorkerThread
    public void zza(String str, URL url, Map map, zza zzaVar) {
        zzjk();
        zzjv();
        com.google.android.gms.common.internal.zzx.zzz(url);
        com.google.android.gms.common.internal.zzx.zzz(zzaVar);
    ...
    @WorkerThread
    public void zza(String str, URL url, byte[] bArr, Map map, zza zzaVar) {
        zzjk();
        zzjv();
        com.google.android.gms.common.internal.zzx.zzz(url);
