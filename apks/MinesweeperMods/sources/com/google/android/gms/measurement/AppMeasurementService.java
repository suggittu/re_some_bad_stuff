...
public final class AppMeasurementService extends Service {
    ...
    public static boolean zzZ(Context context) {
        ...
        boolean zZza = zzaj.zza(context, AppMeasurementService.class);
    ...
    public final int onStartCommand(Intent intent, int i, final int i2) {
        ...
        String action = intent.getAction();
        if (zzwVarZzaT.zzCp().zzkr()) {
            zzpVarZzAo.zzCK().zze("Device AppMeasurementService called. startId, action", Integer.valueOf(i2), action);
        } else {
            zzpVarZzAo.zzCK().zze("Local AppMeasurementService called. startId, action", Integer.valueOf(i2), action);
        }
