...
public class zzx extends zzm.zza {
    ...
    @BinderThread
    public List zza(final AppMetadata appMetadata, boolean z) {
        com.google.android.gms.common.internal.zzx.zzz(appMetadata);
        zzfm(appMetadata.packageName);
        try {
            List<zzai> list = (List) this.zzaTV.zzCn().zzd(new Callable() { // from class: com.google.android.gms.measurement.internal.zzx.6
