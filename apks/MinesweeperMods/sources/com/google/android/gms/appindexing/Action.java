...
public final class Action extends Thing {
    ...
    public final class Builder extends Thing.Builder {
        ...
        public final Action build() {
            ...
            zzx.zzb(bundle.get(PlusShare.KEY_CALL_TO_ACTION_URL), "Must call setObject() with a valid app URI. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
