...
public class MediaQueueItem {
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.zzaaU == null) == (mediaQueueItem.zzaaU == null)) {
            return (this.zzaaU == null || mediaQueueItem.zzaaU == null || zznb.zze(this.zzaaU, mediaQueueItem.zzaaU)) && zzf.zza(this.zzabd, mediaQueueItem.zzabd) && this.zzabe == mediaQueueItem.zzabe && this.zzabf == mediaQueueItem.zzabf && this.zzabg == mediaQueueItem.zzabg && this.zzabh == mediaQueueItem.zzabh && this.zzabi == mediaQueueItem.zzabi && zzf.zza(this.zzabj, mediaQueueItem.zzabj);
        }
        return false;
    }
