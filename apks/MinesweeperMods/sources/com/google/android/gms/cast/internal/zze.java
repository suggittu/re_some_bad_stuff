...
public final class zze extends com.google.android.gms.common.internal.zzj {
    ...
    final class zza implements Cast.ApplicationConnectionResult {
    ...
    class zzb extends zzj.zza {
        ...
        private void zza(zze zzeVar, long j, int i) {
            ...
            synchronized (zzeVar.zzadM) {
                zzbVar = (zza.zzb) zzeVar.zzadM.remove(Long.valueOf(j));
            }
            if (zzbVar != null) {
        ...
        public void onApplicationDisconnected(final int i) {
            final zze zzeVar = (zze) this.zzadU.get();
            if (zzeVar == null) {
                return;
            }
            zzeVar.zzadJ = null;
            ...
            if (zzeVar.zzZP != null) {
                this.mHandler.post(new Runnable() { // from class: com.google.android.gms.cast.internal.zze.zzb.1
                    ...
                    public void run() {
                        zzeVar.zzZP.onApplicationDisconnected(i);
                    }
                });
            }
        }
        ...
        public zze zzos() {
            zze zzeVar = (zze) this.zzadU.getAndSet(null);
            if (zzeVar == null) {
                return null;
            }
            zzeVar.zzoh();
    ...
    private void zza(zza.zzb zzbVar) {
        synchronized (zzadP) {
            if (this.zzadN != null) {
    ...
    private void zzc(zza.zzb zzbVar) {
        synchronized (zzadQ) {
            if (this.zzadO != null) {
    ...
    public final void zza(String str, LaunchOptions launchOptions, zza.zzb zzbVar) {
        zza(zzbVar);
        ((zzi) zzqJ()).zza(str, launchOptions);
    }

    public final void zza(String str, zza.zzb zzbVar) {
        zzc(zzbVar);
        ((zzi) zzqJ()).zzck(str);
    }

    public final void zza(String str, String str2, JoinOptions joinOptions, zza.zzb zzbVar) {
        zza(zzbVar);
        if (joinOptions == null) {
    ...
    public final void zza(String str, String str2, zza.zzb zzbVar) {
        ...
        try {
            ...
            ((zzi) zzqJ()).zzb(str, str2, jIncrementAndGet);
        } catch (Throwable th) {
    ...
    public final void zza(String str, boolean z, zza.zzb zzbVar) {
    ...
    public final zzi zzW(IBinder iBinder) {
        return zzi.zza.zzaF(iBinder);
    }

    public final void zzb(zza.zzb zzbVar) {
        zzc(zzbVar);
        ((zzi) zzqJ()).zzou();
    }
    ...
    public final void zzcg(String str) {
        ...
        synchronized (this.zzadz) {
            messageReceivedCallback = (Cast.MessageReceivedCallback) this.zzadz.remove(str);
        }
        if (messageReceivedCallback != null) {
            try {
                ((zzi) zzqJ()).zzcm(str);
