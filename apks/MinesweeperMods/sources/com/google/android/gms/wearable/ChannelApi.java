...
public interface ChannelApi {
    ...
    PendingResult addListener(GoogleApiClient googleApiClient, ChannelListener channelListener);

    PendingResult openChannel(GoogleApiClient googleApiClient, String str, String str2);

    PendingResult removeListener(GoogleApiClient googleApiClient, ChannelListener channelListener);
}
