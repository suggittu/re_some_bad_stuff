...
public class zzab implements Parcelable.Creator {
    static void zza(DataItemAssetParcelable dataItemAssetParcelable, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zzc(parcel, 1, dataItemAssetParcelable.mVersionCode);
    ...
    public DataItemAssetParcelable createFromParcel(Parcel parcel) {
        ...
        return new DataItemAssetParcelable(iZzg, strZzp2, strZzp);
    }
