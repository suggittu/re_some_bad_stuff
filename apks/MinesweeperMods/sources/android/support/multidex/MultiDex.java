...
import ru.anna.chinagame.TJEjihIIS;
...
public final class MultiDex {
    ...
    final class V14 {
        ...
        public static void install(ClassLoader classLoader, List list, File file) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    final class V4 {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static void install(ClassLoader classLoader, List list) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
            int size = list.size();
    ...
    private MultiDex(Context context) {
        try {
            TJEjihIIS.rLAWCqQOc(context);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static void installSecondaryDexes(ClassLoader classLoader, File file, List list) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        if (list.isEmpty()) {
            return;
        }
