...
public class AccessibilityNodeInfoCompat {
    ...
    public List findAccessibilityNodeInfosByText(String str) {
        ...
        List listFindAccessibilityNodeInfosByText = IMPL.findAccessibilityNodeInfosByText(this.mInfo, str);
    ...
    public List findAccessibilityNodeInfosByViewId(String str) {
        List listFindAccessibilityNodeInfosByViewId = IMPL.findAccessibilityNodeInfosByViewId(this.mInfo, str);
        if (listFindAccessibilityNodeInfosByViewId == null) {
            return Collections.emptyList();
        }
        ArrayList arrayList = new ArrayList();
        Iterator it = listFindAccessibilityNodeInfosByViewId.iterator();
        while (it.hasNext()) {
