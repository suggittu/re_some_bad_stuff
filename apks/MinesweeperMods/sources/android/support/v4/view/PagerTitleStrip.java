...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(size, ViewCompat.resolveSizeAndState(iMax, i2, ViewCompat.getMeasuredState(this.mCurrText) << 16));
    }
    ...
    void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((getWidth() - getPaddingLeft()) - getPaddingRight()) * 0.8f)), ExploreByTouchHelper.INVALID_ID);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(Math.max(0, (getHeight() - getPaddingTop()) - getPaddingBottom()), ExploreByTouchHelper.INVALID_ID);
