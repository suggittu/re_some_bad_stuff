...
public class ViewPager extends ViewGroup {
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            ...
            accessibilityRecordCompatAsRecord.setScrollable(canScroll());
            if (accessibilityEvent.getEventType() != 4096 || ViewPager.this.mAdapter == null) {
                return;
            }
            accessibilityRecordCompatAsRecord.setItemCount(ViewPager.this.mAdapter.getCount());
            accessibilityRecordCompatAsRecord.setFromIndex(ViewPager.this.mCurItem);
            accessibilityRecordCompatAsRecord.setToIndex(ViewPager.this.mCurItem);
        }
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        for (int i7 = i - 1; i7 >= 0; i7--) {
            ...
            f2 = pageWidth3 - (itemInfo5.widthFactor + f);
            itemInfo5.offset = f2;
        ...
        for (int i9 = i + 1; i9 < size2; i9++) {
            ...
            f3 = pageWidth4 + itemInfo6.widthFactor + f;
            i8++;
        }
        this.mNeedCalculatePageOffsets = false;
    }
    ...
    private boolean performDrag(float f) {
        ...
        if (scrollX < f4) {
            if (z) {
                zOnPull = this.mLeftEdge.onPull(Math.abs(f4 - scrollX) / clientWidth);
            }
        } else if (scrollX > f2) {
            zOnPull = z2 ? this.mRightEdge.onPull(Math.abs(scrollX - f2) / clientWidth) : false;
            f4 = f2;
        } else {
            f4 = scrollX;
        }
    ...
    */
    ...
    public void setPageTransformer(boolean z, PageTransformer pageTransformer) throws IllegalAccessException, Resources.NotFoundException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 11) {
