...
public final class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i, @IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i2, @IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float fAbs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i, @IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i2, @IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i, @IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i2, @IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = Connections.DURATION_INDEFINITE, to = 255) int i2) {
        if (i2 < 0 || i2 > 255) {
