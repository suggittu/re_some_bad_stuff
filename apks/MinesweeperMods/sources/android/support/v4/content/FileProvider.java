...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) throws IOException {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                File fileBuildPath = TAG_ROOT_PATH.equals(name) ? buildPath(DEVICE_ROOT, attributeValue2) : TAG_FILES_PATH.equals(name) ? buildPath(context.getFilesDir(), attributeValue2) : TAG_CACHE_PATH.equals(name) ? buildPath(context.getCacheDir(), attributeValue2) : TAG_EXTERNAL.equals(name) ? buildPath(Environment.getExternalStorageDirectory(), attributeValue2) : null;
