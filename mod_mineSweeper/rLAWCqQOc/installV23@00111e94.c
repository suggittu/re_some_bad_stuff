...
/* installV23(_JNIEnv*, _jclass*, _jobject*, _jobjectArray*, _jobject*) */

void installV23(_JNIEnv *param_1,_jclass *param_2,_jobject *param_3,_jobjectArray *param_4,
               _jobject *param_5)

{
  ...
  if ((param_4 != (_jobjectArray *)0x0 && param_5 != (_jobject *)0x0) &&
    ...
    uVar3 = replaceStringForInt(10);
    uVar6 = replaceStringForInt(0xb);
